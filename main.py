...
class Buttons:
    ...
    class Edit:
        ...
        commanders = types.InlineKeyboardButton(text='Изменить ДКЛ', callback_data='edit commanders')
    ...
    class Message:
        send = types.InlineKeyboardButton(text='Отправить', callback_data='message send')
        cancel = types.InlineKeyboardButton(text='Отмена', callback_data='message cancel')
...
class Markup:
    ...
    class Squads:
        ...
        for squad in Buttons.Squads.concrete:
            show.add(squad)
        show.add(Buttons.Squads.hide_buttons)
    ...
    class Message:
        ...
        show.add(Buttons.Message.send, Buttons.Message.cancel)
